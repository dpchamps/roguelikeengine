export enum KeyCode {
  ...
  /** The Eisu key. This key's purpose is defined by the IME, but may be used to closeText the IME. */
  Eisu = 'Eisu',
  ...
  /** Switches to the input "AbstractComponent 1." */
  TVInputComponent1 = 'TVInputComponent1',

  /** Switches to the input "AbstractComponent 2." */
